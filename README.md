# AG-Spiel API für Python ![GitHub](https://img.shields.io/github/license/KingKevin23/agspiel-python-api) [![Python 3.8](https://img.shields.io/badge/python-3.8-blue.svg)](https://www.python.org/downloads/release/python-380/)
